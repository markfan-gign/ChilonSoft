...
namespace ChilonSoft.Helpers
{
    public class ImageHelper
    {
        ...
        public static void AddWater(string Path, string Path_sy, string addText, int fontSize, string font)
        {
            System.Drawing.Image image = System.Drawing.Image.FromFile(Path);
            System.Drawing.Graphics g = System.Drawing.Graphics.FromImage(image);
            g.DrawImage(image, 0, 0, image.Width, image.Height);
            System.Drawing.Font f = new System.Drawing.Font("宋体", fontSize);
        ...
        /// </summary>
        /// <param name="Path">原服务器图片路径</param>
        /// <param name="Path_sy">生成的带文字图片路径</param>
        /// <param name="addText">文字</param>
        public static void ConvertStringToImage(string Path, string Path_sy, string addText, int fontSize, string font)
        {
            System.Drawing.Image image = System.Drawing.Image.FromFile(Path);
            System.Drawing.Graphics g = System.Drawing.Graphics.FromImage(image);
            g.DrawImage(image, 0, 0, 278, 40);
            System.Drawing.Font f = new System.Drawing.Font("宋体", fontSize);
            System.Drawing.Brush b = new System.Drawing.SolidBrush(System.Drawing.Color.Red);

            g.DrawString(addText, f, b, 278 - addText.Length * fontSize * 3 / 2, 40 - fontSize * 3);
            g.Dispose();
        ...
        {
            imagesurl1 = imagesurl1.Substring(1);
            string tmpRootDir = System.Web.HttpContext.Current.Server.MapPath(System.Web.HttpContext.Current.Request.ApplicationPath.ToString());//获取程序根目录
        ...
        public static void DeleteDiskFile(string ImageUrl)
        {
            try
            {
                //string FilePath = System.Web.HttpContext.Current.Server.MapPath(ImageUrl);//转换物理路径
